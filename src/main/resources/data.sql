...
INSERT INTO sky_user (first_name, last_name, email, current_timer_running, timer_start_time, started_sport, points, office) VALUES
    ...
    ('Mark', 'Wilson', 'mark.wilson@sky.uk', TRUE, '2024-10-01 09:30:00', 'Running', 25, 1),
    ('Sara', 'Davis', 'sara.davis@sky.uk', FALSE, NULL, NULL, 30, 2),
    ('Michael', 'Brown', 'michael.brown@sky.uk', TRUE, '2024-10-01 10:00:00', 'Cycling', 10, 3),
    ('Emily', 'Taylor', 'emily.taylor@sky.uk', FALSE, NULL, NULL, 5, 0),
    ('David', 'Anderson', 'david.anderson@sky.uk', TRUE, '2024-10-01 11:15:00', 'Swimming', 20, 1),
    ('Laura', 'Thomas', 'laura.thomas@sky.uk', FALSE, NULL, NULL, 12, 2),
    ('James', 'Jackson', 'james.jackson@sky.uk', TRUE, '2024-10-01 12:30:00', 'Basketball', 18, 3),
    ('Sophia', 'White', 'sophia.white@sky.uk', FALSE, NULL, NULL, 22, 0),
    ('Daniel', 'Harris', 'daniel.harris@sky.uk', FALSE, NULL, NULL, 28, 1),
    ('Olivia', 'Martin', 'olivia.martin@sky.uk', TRUE, '2024-10-01 13:45:00', 'Tennis', 14, 2),
    ('Benjamin', 'Lee', 'benjamin.lee@sky.uk', FALSE, NULL, NULL, 9, 3),
    ('Mia', 'Walker', 'mia.walker@sky.uk', TRUE, '2024-10-01 14:50:00', 'Yoga', 11, 0),
    ('Liam', 'Hall', 'liam.hall@sky.uk', FALSE, NULL, NULL, 17, 1),
    ('Ava', 'Allen', 'ava.allen@sky.uk', TRUE, '2024-10-01 15:30:00', 'Soccer', 13, 2);
...
INSERT INTO team (name, imageURL, description, date_created, created_by_id) VALUES
    ('The Champions', 'http://example.com/images/champions.png', 'A team of champions competing for the top spot.', '2015-09-09 20:22:15', 1),
    ('The Mavericks', 'http://example.com/images/mavericks.png', 'Innovative thinkers breaking the mold.', '2016-01-15 14:22:30', 2),
    ('The Warriors', 'http://example.com/images/warriors.png', 'Fierce competitors with a strong bond.', '2017-03-12 18:45:00', 3),
    ('The Dream Team', 'http://example.com/images/dreamteam.png', 'A legendary group with dreams of victory.', '2018-07-22 10:10:10', 1),
    ('The Explorers', 'http://example.com/images/explorers.png', 'Adventurers seeking new challenges.', '2019-11-05 09:30:45', 2),
    ('The Guardians', 'http://example.com/images/guardians.png', 'Protectors of the realm, united as one.', '2020-02-20 16:50:00', 5),
    ('The Innovators', 'http://example.com/images/innovators.png', 'Pioneers of new ideas and strategies.', '2021-05-10 11:20:30', 4),
    ('The Gladiators', 'http://example.com/images/gladiators.png', 'Brave warriors ready for battle.', '2022-08-18 17:55:15', 1),
    ('The Titans', 'http://example.com/images/titans.png', 'Colossal players dominating the field.', '2023-01-01 12:00:00', 2),
    ('The Legends', 'http://example.com/images/legends.png', 'Creating a legacy that will be remembered.', '2023-03-15 15:30:00', 7);
